...
parser.add_argument('--load', type=str, default='./smt_tiny.pth', help='load SMT backbone checkpoints')
parser.add_argument('--gpu_id', type=str, default='0', help='train with gpu')
